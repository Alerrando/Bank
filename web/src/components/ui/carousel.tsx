  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute h-6 md:h-8 w-6 md:w-8 rounded-full",
          orientation === "horizontal" ? "-left-8 md:-left-12 top-1/2 -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
          className,
        )}
  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute h-6 md:h-8 w-6 md:w-8 rounded-full",
          orientation === "horizontal" ? "-right-8 md:-right-12 top-1/2 -translate-y-1/2" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90",
          className,
        )}
