...
export default function HeaderAdm() {
  ...
  return (
    <header className="w-full md:w-[calc(100%_-_11%)] bg-[#F2F2F2] flex items-center justify-between py-3 px-2 xl:px-5 border-b border-b-primary absolute top-0 right-0">
