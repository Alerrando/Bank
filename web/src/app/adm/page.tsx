              ...
              {Array.from({ length: 2 }).map((__, index: number) => (
                <>
                  <CarouselItem className={`w-full flex items-center gap-4`} key={index}>
                    <div
                      className={`w-full h-52 flex flex-col items-start justify-between text-white ${cardsWallet[(index + 1) * index].gradient} rounded-lg relative p-8`}
                    >
                      ...
                      <div className="w-full flex items-center justify-between">
                        <div className="text-bold text-[#Ffd700] text-lg">
                          {cardsWallet[(index + 1) * index].numberCard}
                        </div>
                    ...
                    <div
                      className={`w-full h-52 flex flex-col items-start justify-between text-white ${cardsWallet[index + 1].gradient} rounded-lg relative p-8`}
                    >
                      <div className="grid gap-2">
